...
#config
version = "v0.29" #note to myself: modify this later on next versions
...
#looped stuff
    ...
    #cmd system stuff
        if cmd == '>help':
            ...
            print('- >customscript         : Runs a custom script (Python only) made by you (customizable!)')
            ...
            try:
                ...
                checkline()
                print("Error, couldn't read path or not a valid path!")
