...
#config
version = "v0.31" #note to myself: modify this later on next versions
...
#looped stuff
    ...
    #cmd system stuff
        if cmd == '>help':
            ...
            print('- >runningprocess       : View all the running services in the background')
            print('- >guessnumber          : Play the guess-a-number game')
            print('- >spam                 : Tool to spam easier')
            ...
            print("Video Duration : ",yt.length, "s")
            checkline()
            ...
            n = input("Spam count: ")
            checkline()
            print("Spamming will begin in:")
            countdown(int(0), int(0), int(10))
            print("Spamming!")
            ...
            a,b=input("Enter number range [Format: num1,num2]:\n").split(',')
            a = int(a)
            b = int(b)
            checkline()
            if b in range(1,11):
                print("[Difficulty: Super Easy]")
            elif b in range(11,31):
                print("[Difficulty: Easy]")
            elif b in range(31,51):
            ...
            #easter egg
                ...
                print("[Difficulty: Satan]")
            elif b == 69420:
                print("[Difficulty: Nice]")
                
            else:
                print("[Difficulty: Super Hard]")
                
            num = random.randint(a,b)
            num = str(num)
            checkline()
            print("Type 'igiveup' to give up\n")
