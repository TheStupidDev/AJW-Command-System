...
#config
version = "v0.26" #note to myself: modify this later on next versions
...
def configreset():
    ...
    with open('ajwconfig.txt', 'w+') as f:
        ...
        f.write("\n#If there is a problem with opeing the AJW program, delete this config file first and launch AJW Command System again")
        wait(0.1)
        print("==============================================")
...
#looped stuff
    ...
    #cmd system stuff
        if cmd == '>help':
            ...
            print("==============================================")
            print(f"Your reaction speed {reactiontime*1000:.0f} ms!")
